      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li ><a href="capital" class="active">Calcule Capital <span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="text-align: center;">
          <section class="content bgcolor-1">
				...
				<h2>Calcule de Capital</h2>
				<form action="${empty capitale ? 'capital' : 'capital/add'}" method="post">
				<ul>
				
				<c:if test="${not empty  capitale }">
				<li>
				<span class="input input--yoshiko">
				<input class="input__field input__field--yoshiko" type="number" id="input-15" name="capitale"  step="any" value="${ capitale }" readonly="readonly"
	>
				...
				<li>
				<span class="input input--yoshiko">
				<input class="input__field input__field--yoshiko" type="number" id="input-10" name="annuite"  step="any" value="${ annuite }" <c:if test="${not empty  capitale }">
	 readonly="readonly"
	</c:if>>
				...
				<li>
				<span class="input input--yoshiko">
					<input class="input__field input__field--yoshiko" type="number" id="input-11" name="duree"  step="any" value="${ duree }" <c:if test="${not empty  capitale }">
	 readonly="readonly"
	</c:if>>
				...
				<li>
				<span class="input input--yoshiko">
					<input class="input__field input__field--yoshiko" type="number" id="input-12" name="taux"  step="any" value="${ taux }" <c:if test="${not empty  capitale }">
	 readonly="readonly"
	</c:if>>
				...
				<input type="submit" value="${empty capitale ? 'calculer' : 'enregistrer'}">
				</form>
			</section>
