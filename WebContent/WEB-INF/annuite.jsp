      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="annuite" class="active">Calcule Annuite</a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="text-align: center;">
          <section class="content bgcolor-1">
				...
				<h2>Calcule d'Annuite</h2>
				<form action="${empty annuite ? 'annuite' : 'annuite/add'}" method="post">
				<ul>
				
				<c:if test="${not empty  annuite }">
				<li>
				<span class="input input--yoshiko">
				<input class="input__field input__field--yoshiko" type="number" id="input-15" name="annuite"  step="any" value="${ annuite }" readonly="readonly"
	>
				...
				<li>
				<span class="input input--yoshiko">
				<input class="input__field input__field--yoshiko" type="number" id="input-10" name="capitale"  step="any" value="${ capitale }" <c:if test="${not empty  annuite }">
	 readonly="readonly"
	</c:if>>
				...
				<li>
				<span class="input input--yoshiko">
					<input class="input__field input__field--yoshiko" type="number" id="input-11" name="duree"  step="any" value="${ duree }" <c:if test="${not empty  annuite }">
	 readonly="readonly"
	</c:if>>
				...
				<li>
				<span class="input input--yoshiko">
					<input class="input__field input__field--yoshiko" type="number" id="input-12" name="taux"  step="any" value="${ taux }" <c:if test="${not empty  annuite }">
	 readonly="readonly"
	</c:if>>
